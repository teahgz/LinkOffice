...
public interface ApprovalRepository extends JpaRepository<Approval, Long>{
	...
	@Query(value = "SELECT * FROM (" +
	        ...
	        "           member_no, " +
	        "           vacation_approval_title, " +
	        "           NULL AS approval_effective_date, " +
	        "           vacation_approval_content, " +
	        "           vacation_approval_status, " +
	        "           vacation_approval_create_date, " +
	        "           vacation_approval_update_date, " +
	        "           vacation_approval_cancel_reason " +
	        ...
	        ") AS combined " +
	        "ORDER BY approval_create_date DESC", 
	        nativeQuery = true)
	List<Approval> findAllApprovalReferences(@Param("loggedInMemberNo") Long memberNo);

	// 제목 검색 (참조함)
	@Query(value = "SELECT approval_no, " +
	        "member_no, " +
	        "approval_title, " +
	        "approval_effective_date, " +
	        "approval_content, " +
	    ...
	    nativeQuery = true)
	List<Approval> findAllApprovalReferencesTitle(@Param("loggedInMemberNo") Long memberNo, @Param("searchText") String searchText);
	...
	@Query(value = "SELECT approval_no, " +
	    ...
	    nativeQuery = true)
	List<Approval> findAllApprovalReferencesStatus(@Param("loggedInMemberNo") Long memberNo, 
	...
	@Query(value = "SELECT approval_no, " +
	        ...
	        "     OR (:searchText = '취소' AND va.vacation_approval_status = 3))", 
	    nativeQuery = true)
	List<Approval> findAllApprovalReferencesTitleAndStatus(@Param("loggedInMemberNo") Long memberNo, 
	                                    @Param("searchText") String searchText);
